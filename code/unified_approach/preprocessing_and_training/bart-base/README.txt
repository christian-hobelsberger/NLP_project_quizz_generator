...
2. Open the QA_CL_base_model.py, and read comments for the global variables: change at least ALL the save paths.
...
'TestingQAModel.py' in the preprocessing_and_training folder shows how to load and use the model to generate outputs, if you have the model and
