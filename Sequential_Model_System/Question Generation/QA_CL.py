...
save_path_model_train = os.path.join(os.environ.get('TMPDIR'), 'results_CL_large_QA', 'model_CL_QA_large_train')
save_path_model_test = os.path.join(os.environ.get('TMPDIR'), 'results_CL_large_QA', 'model_CL_QA_large_test')
...
def obtain_tokenized_filtered_splits(dataset):
    for split in dataset.keys():
        ...
        merged_column_output = [' '.join(row) for row in zip(question_labels, current_dataset["question"], answer_labels, current_dataset["correct_answer"])]
